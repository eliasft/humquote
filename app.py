...
#     load_factor = st.number_input('Load Escalation Factor', value=1.15, on_change=update_escalated_data)
#     retail_factor = st.number_input('Retail Escalation Factor', value=1.15, on_change=update_escalated_data)
